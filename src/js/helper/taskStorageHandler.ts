...
export const taskStorageHandler = {
   ...
   *
   * @returns  The list of tasks stored in localStorage. If no tasks are found, an empty array is returned.
   */
  get(): Task[] {
   ...
   *
   * @param tasks - The list of tasks to store in localStorage.
   */
  set(tasks: Task[]) {
